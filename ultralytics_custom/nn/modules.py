...
from ultralytics_custom.yolo.utils.tal import dist2bbox, make_anchors
...
class NAM_Attention(nn.Module):
    def __init__(self, channels, out_channels=None, no_spatial=True):
        super(NAM_Attention, self).__init__()
...
class ChannelAttentionModule(nn.Module):
    def __init__(self, c1, reduction=16):
        ...
        with torch.backends.cudnn.flags(enabled=False):
            # Turn off determinism just for this operation
